  ...
  lessons: [
    {
      ...
      minutes: 14,
      blocks: [
        { type: 'text', md: r`RWKV 从 2021 年的 v1 一路演进到 v7（代号 Goose），2025 年起 v8（代号 Heron）又以「特性逐个发布」的新节奏推进。理解演进路线能帮你读懂社区代码与论文——你会发现所有改动都在回答同一个问题：**如何让固定大小的状态记住更多、更准。**` },
        { type: 'table', head: ['版本', '年代', '关键改动'], rows: [
          ...
          ['v7 (Goose)', '2025', '广义 delta rule：状态可按规则「先擦除再写入」；meta-in-context learner，第一性原理推导（2026 年已有 G1 系列 13B/7B/3B 开源模型）'],
          ['v8 (Heron)', '2025-', 'DeepEmbed 稀疏知识库、DEA 混合注意力、ROSA 后缀自动机符号检索——详见第 13 章'],
        ], caption: '演进主线：状态的「读写规则」越来越精细；v8 开始引入神经符号混合路线。' },
